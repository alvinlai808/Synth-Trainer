...
const ADSRCard = ({attackStuff, decayStuff, sustainStuff, releaseStuff, frequencyStuff}) => {
  ...
  return (
    <Card id="envelope-card" className="text-center" style={{backgroundColor:"black"}}>
      <Card.Title id="envelope-label" style={{ color: "dimgray" }}>ADSR Envelope</Card.Title>
